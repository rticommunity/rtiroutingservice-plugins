    ...
    void **handle_out)
{
    ...
    *native_handle = (HANDLE)
        _beginthread((void(__cdecl *) (void *))thread, 0, arg);
    if (*native_handle == NULL)
    {
                             ...
                             DDS_Boolean *match_out)
{
    ...
    char f_ch = '\0',
         f_ch_next = '\0',
         v_ch = '\0';
    DDS_Boolean match = DDS_BOOLEAN_TRUE,
...
RTI_MQTT_QosLevel_from_mqtt_qos(
    int mqtt_qos, RTI_MQTT_QosLevel *level_out)
{
...
RTI_MQTT_ClientConfig_default(RTI_MQTT_ClientConfig **config_out)
{
    ...
    if (!RTI_MQTT_ClientConfig_copy(config, &RTI_MQTT_ClientConfig_DEFAULT))
    {
        RTI_MQTT_LOG_COPY_DATA_FAILED(
            "RTI_MQTT_ClientConfig", config, &RTI_MQTT_ClientConfig_DEFAULT)
        goto done;
    }
...
RTI_MQTT_SubscriptionConfig_default(RTI_MQTT_SubscriptionConfig **config_out)
{
    ...
    if (!RTI_MQTT_SubscriptionConfig_copy(
                config, &RTI_MQTT_SubscriptionConfig_DEFAULT))
    {
        RTI_MQTT_LOG_COPY_DATA_FAILED("RTI_MQTT_SubscriptionConfig", 
            config, &RTI_MQTT_SubscriptionConfig_DEFAULT)
        goto done;
    }
...
RTI_MQTT_PublicationConfig_default(RTI_MQTT_PublicationConfig **config_out)
{
    ...
    {
        RTI_MQTT_LOG_COPY_DATA_FAILED("RTI_MQTT_PublicationConfig", 
                config, &RTI_MQTT_PublicationConfig_DEFAULT)
        goto done;
    }
...
static RTIBool
RTI_MQTT_DDS_DynamicDataPtr_initialize_w_params(
...
static RTIBool
RTI_MQTT_DDS_DynamicDataPtr_finalize_w_params(
    DDS_DynamicData **self,
    const struct DDS_TypeDeallocationParams_t * deallocParams)
{
    *self = NULL;
...
static RTIBool
RTI_MQTT_DDS_DynamicDataPtr_copy(
    DDS_DynamicData **dst,
...
RTI_MQTT_Mutex_initialize(RTI_MQTT_Mutex *self)
{
    ...
    if (0 != pthread_mutexattr_settype(
