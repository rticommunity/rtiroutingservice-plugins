    ...
    struct RTI_RS_MQTT_MessageWriter **writer_out)
{
    ...
    *writer_out = NULL;
    ...
    writer = (struct RTI_RS_MQTT_MessageWriter*)
            RTI_MQTT_Heap_allocate(sizeof(struct RTI_RS_MQTT_MessageWriter));
    if (writer == NULL)
    {
        /* TODO Log error */
        goto done;
    ...
    if (DDS_RETCODE_OK !=
            RTI_MQTT_Client_publish(writer->connection->client,
                                    &writer->config->pub,
                                    &writer->pub))
    {
        /* TODO Log error */
...
void
RTI_RS_MQTT_MessageWriter_delete(struct RTI_RS_MQTT_MessageWriter *writer)
{
...
RTIBool
RTI_RS_MQTT_MessageWriterPtr_initialize_w_params(
...
RTIBool
RTI_RS_MQTT_MessageWriterPtr_finalize_w_params(
    struct RTI_RS_MQTT_MessageWriter **self,
...
RTIBool
RTI_RS_MQTT_MessageWriterPtr_copy(
