...
ByInputNameForwardingEngine::ByInputNameForwardingEngine(
    ByInputNameForwardingEngineConfiguration& config) : ForwardingEngine(config)
{
    RTI_PRCS_FWD_LOG_FN(rti::prcs::fwd::ByInputNameForwardingEngine::ByInputNameForwardingEngine)
}

void
ByInputNameForwardingEngine::get_forwarding_key(
    TypedInput<DynamicData>& input,
    const DynamicData& data,
    std::string& fwd_key_out)
{
    RTI_PRCS_FWD_LOG_FN(rti::prcs::fwd::ByInputNameForwardingEngine::get_forwarding_key)
...
Processor* 
ByInputNameForwardingEnginePlugin::create_processor(
    Route& route,
    const PropertySet& properties)
{
    RTI_PRCS_FWD_LOG_FN(rti::prcs::fwd::ByInputNameForwardingEnginePlugin::create_processor)
...
void 
ByInputNameForwardingEnginePlugin::delete_processor(
    rti::routing::processor::Route& route,
    rti::routing::processor::Processor *processor)
{
    RTI_PRCS_FWD_LOG_FN(rti::prcs::fwd::ByInputNameForwardingEnginePlugin::delete_processor)
    delete processor;
}
...
{
    RTI_PRCS_FWD_LOG_FN(rti::prcs::fwd::ByInputNameForwardingEnginePlugin::ByInputNameForwardingEnginePlugin)
}
