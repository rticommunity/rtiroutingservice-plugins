...
project = 'RTI Routing Service Field Transformations'
...
htmlhelp_basename = 'RTIRoutingServiceTransformFieldDoc'
...
latex_documents = [
    (master_doc, 'RTIRoutingServiceTransformField.tex', 'RTI Routing Service Field Transformations User\'s Manual',
...
man_pages = [
    (master_doc, 'rtiroutingservicetransform', 'RTI Routing Service Field Transformations Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RTIRoutingServiceTransformField', 'RTI Routing Service Field Transformations Documentation',
...
breathe_projects = {
    "RTI Routing Service Field Transformations": "./doxyoutput/xml"
}
breathe_default_project = "RTI Routing Service Field Transformations"
