    ...
    const char *str, RTI_TSFM_Field_FieldType *tck_out)
{
    ...
    else if (RTI_TSFM_String_compare(str,"boolean") == 0 ||
    ...
    else if (RTI_TSFM_String_compare(str,"long long") == 0 ||
        RTI_TSFM_String_compare(str,"int64") == 0)
    {
        *tck_out = RTI_TSFM_Field_FieldType_LONGLONG;
        return DDS_RETCODE_OK;
    }
    else if (RTI_TSFM_String_compare(str,"unsigned long long") == 0 ||
