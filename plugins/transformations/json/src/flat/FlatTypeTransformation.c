...
#include "rtitransform_json_flat.h"
...
#define RTI_TSFM_Json_FlatTypeTransformation_MemberMapping_copy_string(dst_,src_) \
{\
    if ((src_) != NULL)\
    {\
...
static RTIBool
RTI_TSFM_Json_FlatTypeTransformation_MemberMapping_copy(
...
#define T_initialize_w_params   RTI_TSFM_Json_FlatTypeTransformation_MemberMapping_initialize_w_params
#define T_finalize_w_params     RTI_TSFM_Json_FlatTypeTransformation_MemberMapping_finalize_w_params
...
{\
    ...
    case json_string:\
        ...
        {\
            RTI_TSFM_ERROR_3("INVALID JSON: string value too long:",\
                "member=%s, max_len=%d, found_len=%d",\
                (name_), (max_len_), (val_)->u.string.length)\
            goto done;\
        }\
        break;\
    default:\
        RTI_TSFM_ERROR_2("INVALID JSON: member expected to be a string:",\
            "member=%s, found_type=%d", (name_), (val_)->type)\
        goto done;\
    }\
}
...
{\
    ...
    case json_integer:\
        break;\
    default:\
        RTI_TSFM_ERROR_2("INVALID JSON: member expected to be an integer:",\
            "member=%s, found_type=%d", (name_), (val_)->type)\
        goto done;\
    }\
}
...
{\
    ...
    case json_double:\
        break;\
    default:\
        RTI_TSFM_ERROR_2("INVALID JSON: member expected to be a double:",\
            "member=%s, found_type=%d", (name_), (val_)->type)\
        goto done;\
    }\
}
...
{\
    ...
    case json_boolean:\
        break;\
    default:\
        RTI_TSFM_ERROR_2("INVALID JSON: member expected to be a boolean:",\
            "member=%s, found_type=%d", (name_), (val_)->type)\
        goto done;\
    }\
}
...
RTI_TSFM_Json_FlatTypeTransformation_parse_member_short(
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_short(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_long(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_ushort(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
...
static DDS_ReturnCode_t
RTI_TSFM_Json_FlatTypeTransformation_parse_member_ulong(
    RTI_TSFM_Json_FlatTypeTransformation *self,
    RTI_TSFM_Json_FlatTypeTransformation_MemberMapping *member,
    json_value *json_member_val,
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_ulong(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_ulonglong(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_longlong(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
...
static DDS_ReturnCode_t
RTI_TSFM_Json_FlatTypeTransformation_parse_member_float(
    RTI_TSFM_Json_FlatTypeTransformation *self,
    RTI_TSFM_Json_FlatTypeTransformation_MemberMapping *member,
    json_value *json_member_val,
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_float(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_double(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
...
static DDS_ReturnCode_t
RTI_TSFM_Json_FlatTypeTransformation_parse_member_octet(
    RTI_TSFM_Json_FlatTypeTransformation *self,
    RTI_TSFM_Json_FlatTypeTransformation_MemberMapping *member,
    json_value *json_member_val,
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_octet(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_boolean(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
...
static DDS_ReturnCode_t
RTI_TSFM_Json_FlatTypeTransformation_parse_member_char(
    RTI_TSFM_Json_FlatTypeTransformation *self,
    RTI_TSFM_Json_FlatTypeTransformation_MemberMapping *member,
    json_value *json_member_val,
    DDS_DynamicData *sample)
{
    ...
    if (DDS_RETCODE_OK !=
            DDS_DynamicData_set_char(sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, member_val))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    DDS_DynamicData *sample)
{
    ...
    RTI_TSFM_Json_MemberValue_validate_string(
            member->name, json_member_val, member->max_len);

    if (DDS_RETCODE_OK != 
            DDS_DynamicData_set_string(
                    sample, member->name, DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED, json_member_val->u.string.ptr))
    {
        /* TODO Log error */
        goto done;
    }
...
RTI_TSFM_Json_FlatTypeTransformation_get_member_parse_function(
        ...
        RTI_TSFM_Json_FlatTypeTransformation_ParseMemberFn *parse_fn_out)
{
    DDS_ReturnCode_t retcode = DDS_RETCODE_ERROR;
    RTI_TSFM_Json_FlatTypeTransformation_ParseMemberFn parse_fn = NULL;
    

    RTI_TSFM_LOG_FN(RTI_TSFM_Json_FlatTypeTransformation_get_member_parse_function)
        ...
        const char *member_name)
{
    ...
    struct DDS_TypeCode *member_type = NULL,
                        *member_content_type = NULL;
        ...
        struct DDS_TypeCode *input_type)
{
    ...
    mapping = 
        RTI_TSFM_Json_FlatTypeTransformation_MemberMappingSeq_get_reference(
                &self->state->input_mappings, 0);

    if (DDS_RETCODE_OK != 
            RTI_TSFM_Json_FlatTypeTransformation_validate_buffer_member(
                    self, mapping, input_type, self->config->buffer_member))
    {
        /* TODO Log error */
        goto done;
    }
        ...
        struct DDS_TypeCode *output_type)
{
    DDS_ReturnCode_t retcode = DDS_RETCODE_ERROR;
    DDS_ExceptionCode_t ex = DDS_NO_EXCEPTION_CODE;
    DDS_UnsignedLong members_count = 0,
                     i = 0,
                     buffer_member_id = 0;
    struct DDS_TypeCode *member_type = NULL,
                        *member_content_type = NULL;
    ...
    if (self->config->parent.type == RTI_TSFM_TransformationKind_SERIALIZER)
    {
        /* Check that output type has the specified buffer member */
        if (!RTI_TSFM_Json_FlatTypeTransformation_MemberMappingSeq_ensure_length(
                &self->state->output_mappings, 1, 1))
        {
            /* TODO Log error */
            goto done;
        }
        ...
        mapping = 
            RTI_TSFM_Json_FlatTypeTransformation_MemberMappingSeq_get_reference(
                    &self->state->output_mappings, 0);

        if (DDS_RETCODE_OK != 
                RTI_TSFM_Json_FlatTypeTransformation_validate_buffer_member(
                        self, mapping, output_type, self->config->buffer_member))
        {
            /* TODO Log error */
            goto done;
        }
    ...
    if (!RTI_TSFM_Json_FlatTypeTransformation_MemberMappingSeq_ensure_length(
            &self->state->output_mappings, members_count, members_count))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    for (i = 0; i < members_count; i++)
    {
        ...
        if (RTI_TSFM_Json_FlatTypeTransformation_get_member_parse_function(
                self, mapping->kind, &mapping->parse_fn) != DDS_RETCODE_OK)
        {
            /* TODO Log error */
            goto done;
        }
        ...
        RTI_TSFM_LOG_4("created MAPPING:","name=%s, id=%d, kind=%d, max_len=%d",
            mapping->name, mapping->id, mapping->kind, mapping->max_len)
    }
...
DDS_ReturnCode_t
RTI_TSFM_Json_FlatTypeTransformation_initialize(
    RTI_TSFM_Json_FlatTypeTransformation *self,
    ...
    RTI_RoutingServiceEnvironment *env)
{
    ...
    if (DDS_RETCODE_OK != RTI_TSFM_Transformation_initialize(
                                                    &self->parent,
                                                    &plugin->parent,
                                                    input_type_info,
                                                    output_type_info,
    ...
    if (DDS_RETCODE_OK != 
            RTI_TSFM_Json_FlatTypeTransformation_validate_output_type(self, tc))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    const struct RTI_RoutingServiceProperties * properties)
{
    ...
    RTI_TSFM_LOG_FN(RTI_TSFM_Json_FlatTypeTransformationConfig_parse_from_properties)
        ...
        DDS_DynamicData *sample_out)
{
    ...
    RTI_TSFM_TRACE_1("RTI_TSFM_Json_FlatTypeTransformation_serialize:",
            "retcode=%d", retcode)
    ...
    DDS_DynamicData *sample)
{
    ...
    for (i = 0; i < mappings_len; i++)
    {
        ...
        if (member == NULL)
        {
            if (!mapping->optional)
            {
                RTI_TSFM_ERROR_1("required member not found in JSON sample:",
                    "member=%s", mapping->name)
                goto done;
            }
            continue;
        }
        ...
        if (DDS_RETCODE_OK != 
                RTI_TSFM_Json_FlatTypeTransformation_parse_member(
                        self, mapping, member->value, sample))
        {
            /* TODO Log error */
            goto done;
        }
    ...
    DDS_DynamicData *shape)
{
    ...
    RTI_TSFM_LOG_FN(RTI_TSFM_Json_FlatTypeTransformation_deserialize_shape)
    ...
    {
        /* TODO Log error */
        RTI_TSFM_ERROR("failed: insufficient fields")
        goto done;
    }
    ...
    for (i = 0; i < value->u.object.length; i++)
    {
        ...
        if (RTI_TSFM_String_compare(member->name,
                                    SHAPE_TYPE_FIELD_COLOR) == 0)
        {
            ...
            case json_string:
                ...
                {
                    /* TODO Log error */
                    RTI_TSFM_ERROR("failed: invalid COLOR string")
                    goto done;
                }
            ...
            default:
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: COLOR field type")
                goto done;
            }
            ...
            {
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: set COLOR")
                goto done;
            }
        }
        else if (RTI_TSFM_String_compare(member->name,
                                         SHAPE_TYPE_FIELD_X) == 0)
        {
            switch (member_value->type)
            {
            case json_string:
                ...
                member_val_l = 
                    RTI_TSFM_String_to_long(member_value->u.string.ptr,NULL,0);
                break;
            ...
            default:
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: X field type")
                goto done;
            }

            if (DDS_RETCODE_OK != DDS_DynamicData_set_long(
                        shape, 
                        SHAPE_TYPE_FIELD_X,
                        DDS_DYNAMIC_DATA_MEMBER_ID_UNSPECIFIED,
                        member_val_l))
            {
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: set X")
                goto done;
            }
        }
        else if (RTI_TSFM_String_compare(member->name,
                                         SHAPE_TYPE_FIELD_Y) == 0)
        {
            switch (member_value->type)
            {
            case json_string:
            ...
            default:
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: Y field type")
                goto done;
            }
            ...
            {
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: set Y")
                goto done;
            }
        }
        else if (RTI_TSFM_String_compare(member->name,
                                         SHAPE_TYPE_FIELD_SHAPESIZE) == 0)
        {
            switch (member_value->type)
            {
            case json_string:
            ...
            default:
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: SHAPESIZE field type")
                goto done;
            }
            ...
            {
                /* TODO Log error */
                RTI_TSFM_ERROR("failed: set SHAPESIZE")
                goto done;
            }
        }
    }
        ...
        DDS_DynamicData *sample_out)
{
    ...
    if (DDS_RETCODE_OK !=
            RTI_TSFM_Json_FlatTypeTransformation_deserialize_sample(
                self, buffer_seq_buff, buffer_seq_len, sample_out))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    RTI_TSFM_TRACE_1("RTI_TSFM_Json_FlatTypeTransformation_deserialize:",
            "retcode=%d", retcode)
...
{
    RTI_TSFM_Json_FlatTypeTransformationState *retval = NULL,
                                              *state = NULL;
...
static void
RTI_TSFM_Json_FlatTypeTransformationState_delete_data(
