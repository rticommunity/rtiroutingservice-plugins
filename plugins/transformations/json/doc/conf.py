...
project = 'RTI Routing Service Shape Transformations'
...
htmlhelp_basename = 'RTIRoutingServiceTransformShapeDoc'
...
latex_documents = [
    (master_doc, 'RTIRoutingServiceTransformShape.tex', 'RTI Routing Service Shape Transformations User\'s Manual',
...
man_pages = [
    (master_doc, 'rtiroutingservicetransform', 'RTI Routing Service Shape Transformations Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RTIRoutingServiceTransformShape', 'RTI Routing Service Shape Transformations Documentation',
     author, 'RTIRoutingServiceTransformShape', 'An basic transformation that simplifies implementation of transformations for RTI Routing Service in C.',
     'Routing'),
]
...
breathe_projects = {
    "RTI Routing Service Shape Transformations": "./doxyoutput/xml"
}
breathe_default_project = "RTI Routing Service Shape Transformations"
