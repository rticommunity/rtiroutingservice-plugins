...
extern struct RTI_RoutingServiceTransformationPlugin*
...
#ifdef T_static
DDS_ReturnCode_t 
T_serialize(RTI_TSFM_UserTypePlugin *plugin,
            RTI_TSFM_Transformation *self,
            DDS_DynamicData *sample_in,
            DDS_DynamicData *sample_out);

DDS_ReturnCode_t 
T_deserialize(RTI_TSFM_UserTypePlugin *plugin,
              RTI_TSFM_Transformation *self,
              DDS_DynamicData *sample_in,
              DDS_DynamicData *sample_out);
#endif /* T_static */
...
DDS_ReturnCode_t
TPluginConfig_parse(TPluginConfig *self,
                    const struct RTI_RoutingServiceProperties * properties);
#endif /* TPluginConfig_parse */

#ifdef TConfig_parse
DDS_ReturnCode_t
TConfig_parse(TConfig *self,
              const struct RTI_RoutingServiceProperties * properties);
#endif /* TConfig_parse */
