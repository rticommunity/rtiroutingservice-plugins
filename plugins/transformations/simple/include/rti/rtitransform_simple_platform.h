...
#ifndef rtitransform_simple_platform_h
#define rtitransform_simple_platform_h
 ...
 *****************************************************************************/
#include "rtitransform_simple_typesSupport.h"
...
DDS_ReturnCode_t
RTI_TSFM_Mutex_initialize(RTI_TSFM_Mutex *self);

DDS_ReturnCode_t
RTI_TSFM_Mutex_finalize(RTI_TSFM_Mutex *self);

DDS_ReturnCode_t
RTI_TSFM_Mutex_take(RTI_TSFM_Mutex *self);

DDS_ReturnCode_t
RTI_TSFM_Mutex_give(RTI_TSFM_Mutex *self);
#endif /* RTI_TSFM_USE_MUTEX */

#endif /* rtitransform_simple_platform_h */