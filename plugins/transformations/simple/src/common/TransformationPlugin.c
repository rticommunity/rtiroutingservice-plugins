    ...
    RTI_TSFM_TransformationPluginConfig **config_out)
{
    ...
    RTI_TSFM_LOG_FN(RTI_TSFM_TransformationPluginConfig_parse_from_properties_alloc)
    ...
    RTI_TSFM_TransformationPluginConfig **config_out)
{
    ...
    if (!RTI_TSFM_TransformationPluginConfig_copy(
                config, &RTI_TSFM_TransformationPluginConfig_DEFAULT))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    RTI_TSFM_TransformationPluginConfig **config_out)
{
    ...
    config = RTI_TSFM_TransformationPluginConfigTypeSupport_create_data_w_params(
                                                                &alloc_params);
    if (config == NULL)
    {
        /* TODO Log error */
    ...
    RTI_TSFM_TransformationPluginConfig *self)
{
    ...
    RTI_TSFM_TransformationPluginConfigTypeSupport_delete_data(self);
}
    ...
    RTI_RoutingServiceEnvironment *env)
{
    ...
    if (!RTI_TSFM_TransformationPtrSeq_ensure_length(
            &self->transforms, cur_transform_len+1, cur_transform_len+1))
    {
        /* TODO Log error */
        goto done;
    }
    ...
    transform_ref = 
            RTI_TSFM_TransformationPtrSeq_get_reference(
                                    &self->transforms, cur_transform_len);
    
    *transform_ref = transform;

    RTI_TSFM_LOG_2("CREATED transformation:","plugin=%p, tot_transforms=%d",
            self,
            RTI_TSFM_TransformationPtrSeq_get_length(&self->transforms))
    ...
    RTI_RoutingServiceEnvironment *env)
{
    ...
    {
        if (*RTI_TSFM_TransformationPtrSeq_get_reference(
    ...
    if (!do_rm)
    {
        RTI_TSFM_ERROR_3("tranformation NOT FOUND:",
                "plugin=%p, transform=%p, tot_transforms=%d",
                self, transform, seq_len)
        goto done;
    }
    ...
    RTI_TSFM_LOG_2("DELETED transformation:","plugin=%p, tot_transforms=%d",
            self,
            RTI_TSFM_TransformationPtrSeq_get_length(&self->transforms))
